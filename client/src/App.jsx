          ...
          <Routes>
            ...
            <Route path="/" element={<Layout />}>
              ...
              {locations.map((loc) => (
                <Route 
                  key={loc.slug} 
                  path={`best-ias-coaching-centre-in-${loc.slug}/`} 
                  element={<LocationPage citySlug={loc.slug} />} 
                />
              ))}
              ...
              <Route path="tnpsc-course" element={<TNPSC />} />
              <Route path="upsc-course" element={<UPSC />} />
